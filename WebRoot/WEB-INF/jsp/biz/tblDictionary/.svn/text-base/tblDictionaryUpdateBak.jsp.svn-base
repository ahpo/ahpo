...
<script type="text/javascript">
	$(document).ready(function(){
		$("#tblDictionaryUpdate-div").toPanel({
			title:"<s:text name="jsp.tblDictionary.update" />"
		});
...
<div id="tblDictionaryUpdate-div">
	<s:form id="tblDictionaryUpdate" name="tblDictionaryUpdate" action="tblDictionaryUpdate.action" namespace="/" method="post" onsubmit="return jQuery.formValidator.PageIsValid('1')">
		<input type="hidden" name="id" value="<s:property value="tblDictionary.id"/>"/>
		<input type="hidden" name="currentPage" value="<s:property value="currentPage"/>"/>
		<table id="work-list" class="addTable">
			<tr>
				<td class="left-td"><s:text name="jsp.tblDictionary.colLookupKey"/></td>
				<td class="middle-td">
					<input type="text" id="lookupkey" name="lookupkey" value="<s:property value="tblDictionary.lookupkey"/>"/>
			...
			<tr>
				...
				<td class="middle-td">
					<input type="text" id="lookupvalue" name="lookupvalue" value="<s:property value="tblDictionary.lookupvalue"/>"/>
					<font color="#FF0000">*</font>
				</td>
			...
			<tr>
				...
				<td class="middle-td">
					<textarea id="describeinfo" name="describeinfo"><s:property value="tblDictionary.describeinfo"/></textarea>
				</td>
			...
			<tr>
				...
				<td class="middle-td">
					<input type="text" id="backup" name="backup" value="<s:property value="tblDictionary.backup"/>"/>
				</td>
