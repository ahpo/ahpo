...
<script type="text/javascript">
	$(document).ready(function(){
		$("#tblLookupCreate-div").toPanel({
			title:"<s:text name="jsp.tblLookup.create" />"
		});
...
<div id="tblLookupCreate-div">
	<s:form id="tblLookupCreate" name="tblLookupCreate" action="tblLookupCreate" namespace="/" method="post" onsubmit="return jQuery.formValidator.PageIsValid('1')">
		<input type="hidden" name="currentPage" value="<s:property value="currentPage"/>"/>
		<table id="work-list" class="addTable">
			<tr>
				<td class="left-td"><s:text name="jsp.tblLookup.colLookupName"/></td>
				<td class="middle-td">
					<input type="text" id="lookupName" name="lookupName" value=""/>
			...
			<tr>
				...
				<td class="middle-td">
					<input type="text" id="describeinfo" name="describeinfo" value=""/>
				</td>
