 ...
 * 类描述：   
 * 创建人：HO274541   
 * 创建时间：2010-8-17 下午03:44:55   
 * 修改人：HO274541   
 * 修改时间：2010-8-17 下午03:44:55   
 * @version     *
 */
public class IPUtils {
	 ...
	 */
/*	private static String getByName(String hostName) {
		try {
...
/*	private static BigInteger stringToBigInt(String ipInString) {
	 ...
	 * @since  CodingExample　Ver(编码范例查看) 1.1
	 */
/*	private static String bigIntToString(BigInteger ipInBigInt) {
...
/*	private static byte[] ipv4ToBytes(String ipv4) {
	...
	/*private static List<String> getPhysicalAddress() {
		Process p = null;
		// 物理网卡列表
...
/*		List<String> address = IPUtils.getPhysicalAddress(); 
		...
		System.out.println(IPUtils.getHostName("127.0.0.1"));
		BigInteger bi = new BigInteger("2130706433");
